...
**This applies to ALL skills in this collection** — opensearch-launchpad, log-analytics, trace-analytics, aws-setup, managed-ingestion-service, document-processing, and permission-compiler. Regardless of which skill is active, you MUST follow these rules.
