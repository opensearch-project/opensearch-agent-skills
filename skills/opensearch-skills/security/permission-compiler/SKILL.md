...
Stop if the report contains unknown evidence steps, positive probes that
derived no permissions, index actions without a declared scope, or a negative
probe that was allowed. Treat wildcards as a mandatory review item.
